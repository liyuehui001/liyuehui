...
public class BluetoothListActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this,R.layout.list_item_bluetooth);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this,R.layout.list_item_bluetooth);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    ToastUtil.show(context,"没有发现新设备");
                }
            }
        }
    };
